...
/// <summary>
/// 事件参数类型不匹配的代码修复器
/// <remarks>为 EVENT001 诊断提供自动修复功能</remarks>
/// </summary>
[ExportCodeFixProvider(LanguageNames.CSharp, Name = nameof(GameEventTypeCodeFixProvider)), Shared]
public class GameEventTypeCodeFixProvider : CodeFixProvider
{
    /// <summary>
    /// 修复操作的标题
    /// </summary>
    private const string m_title = "修复事件参数类型";

    /// <summary>
    /// 此修复器支持的诊断ID列表
    /// </summary>
    public override ImmutableArray<string> FixableDiagnosticIds =>
        ImmutableArray.Create(Definition.DiagnosticId_TypeMatch);
    ...
    public override async Task RegisterCodeFixesAsync(CodeFixContext context)
    {
        ...
        context.RegisterCodeFix(
            CodeAction.Create(
                title: m_title,
                createChangedDocument: c => FixTypeAsync(context.Document, invocation, c),
    ...
    /// 执行类型修复
    /// </summary>
    private async Task<Document> FixTypeAsync(Document document, InvocationExpressionSyntax invocation,
