...
"%UNITYEDITOR_PATH%\Unity.exe" -projectPath "%WORKSPACE%" -batchmode -quit -logFile "%BUILD_LOGFILE%" -executeMethod DGame.ReleaseTools.AutoBuildWindow -CustomArgs:Language=en_US;"%WORKSPACE%"
