...
Python 3.8+，`pip install -r .codex/skills/luban-dev/scripts/requirements.txt`

### 执行方式

```powershell
python .codex/skills/luban-dev/scripts/luban_helper.py --data-dir GameConfig/Datas <command>
```
