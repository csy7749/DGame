...
{
    public static T CreateInstanceInResource<T>(this object obj, string fileName = "", string path = "")
    ...
    public static VisualElement CreateUIElementInspector(this UnityEngine.Object obj,
    ...
    public static VisualElement CreateUIElementInspector(this SerializedObject serializedObject,
        params string[] propertiesToExclude)
    {
    ...
    /// <returns></returns>
    private static Dictionary<string, UnityEngine.Object> m_AssetDict = new Dictionary<string, UnityEngine.Object>();

    public static T GetAssetByName<T>(string name) where T : UnityEngine.Object
    {
        if (m_AssetDict.TryGetValue(name, out var asset))
        {
            return asset as T;
        }
