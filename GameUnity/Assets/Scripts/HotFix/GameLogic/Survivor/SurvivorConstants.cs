namespace GameLogic
{
    internal static class SurvivorConstants
    {
        ...
        public const float LevelUpDamageMultiplierBonus = 0.25f;
        public const float LevelUpFireIntervalMultiplier = 0.85f;
        public const float MinimumFireIntervalMultiplier = 0.35f;
        ...
        public const float ProjectileBaseDamage = 12f;
        public const int ProjectilePierce = 1;
